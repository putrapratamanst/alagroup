...
function mh_magazine_lite_customize_register($wp_customize) {
	...
	$wp_customize->add_section('mh_magazine_lite_upgrade', array('title' => esc_html__('More Features', 'mh-magazine-lite'), 'priority' => 3, 'panel' => 'mh_theme_options'));
...
function mh_magazine_lite_customizer_js() {
	wp_enqueue_script('mh-customizer', get_template_directory_uri() . '/js/mh-customizer.js', array(), '2.0.5', true);
