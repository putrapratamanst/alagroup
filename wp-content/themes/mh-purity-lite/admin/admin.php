		...
		<div class="theme-info-wrap">
			...
			<div class="theme-links clearfix">
				<p>
					...
					<a href="<?php echo esc_url('http://www.mhthemes.com/themes/mh/purity-lite/'); ?>" target="_blank">
				...
				<div class="row clearfix">
					<div class="col-1-2">
						<div class="section">
							...
							<p>
								<a href="<?php echo esc_url('http://www.mhthemes.com/themes/mh/purity-lite/'); ?>" target="_blank" class="button button-secondary">
						...
						<div class="section">
							...
							<p>
								<a href="<?php echo esc_url('http://www.mhthemes.com/themes/mh/purity/'); ?>" target="_blank" class="button button-secondary">
