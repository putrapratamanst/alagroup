	...
	class MH_Purity_Lite_Upgrade extends WP_Customize_Control {
        public function render_content() {  ?>
			...
			<p class="mh-upgrade-button">
				<a href="http://www.mhthemes.com/themes/mh/purity/" target="_blank" class="button button-secondary">
					<?php esc_html_e('Learn more about MH Purity', 'mh-purity-lite'); ?>
				</a>
			</p><?php
        }
    }
...
function mh_purity_lite_customizer_js() {
	wp_enqueue_script('mh-customizer', get_template_directory_uri() . '/js/mh-customizer.js', array(), '1.0.0', true);
	wp_localize_script('mh-customizer', 'mh_purity_lite_links', array(
		'upgradeURL' => esc_url('http://www.mhthemes.com/themes/mh/purity/'),
		'upgradeLabel' => esc_html__('Upgrade to MH Purity Pro', 'mh-purity-lite'),
		'title'	=> esc_html__('Theme Related Links:', 'mh-purity-lite'),
		'themeURL' => esc_url('http://www.mhthemes.com/themes/mh/purity-lite/'),
		'themeLabel' => esc_html__('Theme Info Page', 'mh-purity-lite'),
		'docsURL' => esc_url('http://www.mhthemes.com/themes/mh/purity-lite/'),
		'docsLabel'	=> esc_html__('Theme Documentation', 'mh-purity-lite'),
		'supportURL' => esc_url('https://wordpress.org/support/theme/mh-purity-lite'),
		'supportLabel' => esc_html__('Support Forum', 'mh-purity-lite'),
		'rateURL' => esc_url('https://wordpress.org/support/view/theme-reviews/mh-purity-lite?filter=5'),
		'rateLabel' => esc_html__('Rate this theme', 'mh-purity-lite'),
	));
}
add_action('customize_controls_enqueue_scripts', 'mh_purity_lite_customizer_js');
