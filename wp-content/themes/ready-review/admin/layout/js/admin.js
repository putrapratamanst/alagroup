jQuery("document").ready(function () {
    jQuery("#ready_review_container").fadeIn(200);
    ...
    jQuery("#ready_review_nav li a").on("click", function () {
    ...
    jQuery(".group-in-tab .group-name").on("click", function () {
    ...
    jQuery(".ready_review_save").on("click", function () {
        var b = jQuery("#ready_review_form").serialize();
        jQuery(".ready_review_save").addClass("button-primary-disabled");
        jQuery(".ready_review_reset").addClass("button-disabled");
        jQuery(".spinner").show();
        jQuery.post('options.php', b).error(
            function () {
                jQuery(".spinner").hide();
                jQuery(".ready_review_reset").removeClass("button-disabled");
                jQuery(".ready_review_save").removeClass("button-primary-disabled");
            }).success(function () {
                jQuery(".spinner").hide();
                jQuery(".ready_review_reset").removeClass("button-disabled");
                jQuery(".ready_review_save").removeClass("button-primary-disabled");
    ...
    jQuery(".ready_review_reset").on("click", function () {
        jQuery(".ready_review_reset").addClass("button-disabled");
        jQuery(".ready_review_save").addClass("button-primary-disabled");
        jQuery(".spinner ").show();
        jQuery.post(ajaxurl, {action: "ready_review_load_defaults"}).error(
            function () {
                jQuery(".spinner").hide();
                jQuery(".ready_review_reset").removeClass("button-disabled");
                jQuery(".ready_review_save").removeClass("button-primary-disabled");
    ...
    jQuery(".ready_review_tipsy ").tipsy();
});