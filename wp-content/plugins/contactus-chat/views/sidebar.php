...
<div id="sidebar-cta" class="text-center">
    ...
    <a href="<?php echo cUsLC_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(trim($upgrade)); ?>" target="_blank" class="btn btn-success btn-block">Get Started with an Upgrade Account</a>
        <hr/>
        <a href="http://wordpress.org/support/view/plugin-reviews/contactus-chat" class="btn btn-review btn-lg btn-block" target="_blank"><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i> <br> <span>Write a Review<i class="icon-pencil"></i></span></a>
    <?php } ?>
