...
<div class="login-form">
    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-1">
            ...
            <form class="form-horizontal" role="form" id="login-form" action="admin.php?page=cUs_live_chat">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-info cUsLC_LoginUser" title="Welcome back ContactUs.com users" data-placement="bottom">Login</button> &nbsp; | &nbsp;
                ...
                <input type="hidden" name="action" value="cUsLC_loginAlreadyUser">
            </form>
        </div>
    </div>
    <div class="row">
