...
<div class="signup-form">
    <h2>Create My First ContactUs.com Chat Form</h2>
    <hr>
    <div class="row">
        <div class="col-sm-11 col-sm-offset-1">

            <form class="form-horizontal" role="form" name="signUp-form" id="signUp-form" action="admin.php?page=cUs_live_chat">
    ...
    <div id="cats_selection">
        ...
        <form action="/" onsubmit="return false;">
            ...
            <div id="customer-categories-box" class="questions-box">
                 ...
                 */
                $aryCategoriesAndSub = $cUsLC_api->getCategoriesSubs();
