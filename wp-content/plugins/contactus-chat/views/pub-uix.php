    ...
    <div class="col-sm-12">
        <div id="cUsLC_tabs">
            <ul class="cu_border-bottom">
                <li><a href="#tabs-1" class="cu_bluebox dashboard-color">ContactUs Chat Plugin</a></li>
            </ul>
            <div id="tabs-1">
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        * @since 1.0
                        */
                        require_once( cUsLC_DIR . 'views/login-form.php');
                        ?>
                        ...
                        * @since 1.0
                        */
                        require_once( cUsLC_DIR . 'views/signup-form.php');
                        ?>
                        ...
                        <div class="contaus_features">
                            ...
                            <div class="road_features">
                                ...
                                <div class="_row r6">
                                    ...
                                    <div class="_col"></div>
                                    <div class="_col"></div>
                                    <div class="_col"><a id="cUsLC_signup_cloud" class="feature cloud setLabels" href="#signupform"></a></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 sidebar">
                         ...
                         * @since 1.0
                         */
                        include( cUsLC_DIR . 'views/sidebar-pub.php');
                        ?>
                    </div>
                </div>
            </div>
