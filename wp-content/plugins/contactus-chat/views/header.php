...
<div class="cUsLC_preloadbox"><div class="cUsLC_loadmessage"><span class="loadingBx"></span></div></div>
<span class="save_message_placement"><p></p></span>
<div id="cu_header">
    <div class="row">
        <div class="col-sm-8">
            <a href="admin.php?page=cUs_live_chat" title="<?php echo cUsLC_PLUGINNAME; ?>"><img src="<?php echo plugins_url('assets/img/contactus.logo.png', dirname(__FILE__) ) ;  ?>" alt="<?php echo cUsLC_PLUGINNAME; ?>"></a>
            <span>|</span>
            <span><?php echo cUsLC_PLUGINNAME; ?></span>
        </div>
        <div class="col-sm-4">
