<?php get_header(); ?>
	...
	?>
		...
		<div class="entry-content">
			...
			<?php if ($wats_settings['ticket_priority_key_enabled'] == 1 && ($wats_settings['wats_ticket_default_keys'][1]['ftdt'] == 1 || ($wats_settings['wats_ticket_default_keys'][1]['ftdt'] == 2 && current_user_can('administrator'))))
			...
			<div class="entry">
				...
				<p class="postmetadata alt">
					<small>
						...
						<?php printf(__("You can follow responses to this entry through the <a href='%s'>RSS 2.0</a> feed.", "WATS"), get_post_comments_feed_link()); ?> 
