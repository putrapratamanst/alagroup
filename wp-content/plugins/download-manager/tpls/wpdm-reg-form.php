...
if(get_option('users_can_register')){
    ...
    <div class="panel-body" -->
        ...
        <div class="row">
            ...
            <?php if($loginurl != ''){ ?>
                <div class="col-md-4"><a href="<?php echo $loginurl;?>" class="btn btn-default btn-lg btn-block" id="registerform-submit" name="wp-submit"><i class="fa fa-lock"></i> &nbsp; <?php _e('Login','download-manager'); ?></a></div>
            <?php } ?>
        </div>
